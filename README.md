...
| :--- | :--- |
| **Kapsül Technology** | 🥇 [**1st Place Winner**](https://www.linkedin.com/feed/update/urn:li:activity:7425207309829795840/) in **Su (Water) Hackathon** (Designed Cloud-based Agri. Adaptation System) |
| **T.C. Min. of Industry & Tech.** | 🇹🇷 Selected as **Top 1,000 Talent** for the **National AI Specialist Program** |
| **Google & T3 Foundation** | 🎓 Selected as an **AI Scholar** for **Game & App Academy** (Top 1,500) |
| **Huawei Cloud** | ☁️ Earned **HCCDA-AI**, **Cloud Native**, and **Tech Essentials** Certifications |
...
* **B.Sc. Computer Engineering** (100% English) - *Bandırma Onyedi Eylül University*
* **Co-Founder** - *3DIZMIR (3D Printing Startup)*
